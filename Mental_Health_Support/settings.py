...
Production-ready configuration for AI/ML Mental Health Chatbot.
"""
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-u(q$g8sz^32vba1dx39*$5+-xjv=60d6)6v-q6i$!2lzf3$6ne')
